...
const DROP_MAGNET_RADIUS  = 80;    // px
const DROP_MAGNET_FORCE   = 1400;  // px/s² em direção ao player
const DROP_MAGNET_MAX_VEL = 600;
const DROP_PICKUP_RADIUS  = 18;    // px (centro a centro)
const DROP_SIZE           = 10;    // px (caixa de colisão e ícone)
